      ...
      <div className="h-screen select-none pb-[120px]">
        <div className="items-around mb-[70px] flex h-full flex-row justify-center gap-20 px-16 py-8">
          <div className="flex w-2/3 max-w-[500px] flex-col justify-center gap-4 pr-20">
            ...
            <p>
              TrailVenture is a platform dedicated to helping outdoor enthusiasts discover and
              navigate trails worldwide. We provide detailed trail maps, user reviews, and real-time
              updates to ensure a safe and enjoyable experience for hikers, bikers, and adventurers.
            </p>
          </div>
          <div className="relative mb-[70px] h-full w-[600px] max-w-[400px] rounded-t-[100px] border-[1px] border-black dark:border-gray-700">
            ...
            />
            <img src={PersonHiking} className="h-full rounded-t-[100px] object-cover p-4"></img>
          </div>
        </div>
      </div>
      <div className="relative mr-[-10px] flex h-screen select-none flex-row items-center gap-16 px-16 py-16">
        <GlowingEffect
          blur={0}
          borderWidth={5}
          spread={80}
        ...
        <div className="w-1/3">
          ...
          <p>
            Our mission is to make outdoor adventures more accessible, safe, and enjoyable by
            offering reliable trail information, GPS tracking, and user-generated reviews. We strive
            to foster a global community of nature lovers who share their experiences and support
      ...
      <div className="mb-[70px] mt-20 flex h-screen select-none flex-col items-start justify-center gap-16 px-16">
        <div className="flex w-full justify-between">
          ...
          <p className="max-w-[400px]">
            Our team of hikers, developers, and environmentalists collaborates to enhance mapping
            technology and engage the TrailVenture community.
          </p>
        </div>
          ...
          {teamInformation.map((teamMember, index) => {
            return (
              ...
              >
                ...
                />
                <div className="h-1/3">
                  <p className="pt-5 text-xl font-semibold">{teamMember.name}</p>
        ...
        <div className="w-1/2">
          <p className="pb-4 text-xl font-semibold">We're looking for talented people</p>
          <p>
            TrailVenture is growing fast, and we are always looking for passionate, dynamic, and
            talented individuals to join our distributed team all around the world
          </p>
        </div>
      </div>
    </div>
