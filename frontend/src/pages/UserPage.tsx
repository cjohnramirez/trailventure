  ...
  return (
    <div className="w-full">
      ...
      <div className="p-8">
        ...
        <div className="relative top-[-40px] grid w-full grid-cols-1 sm:top-[-165px] xl:grid-cols-2">
          <div className="flex max-w-[1300px] flex-col rounded-2xl border-[1px] p-8 sm:ml-12 sm:mr-12 lg:mr-0">
                  ...
                  <div key={index} className="mb-4 rounded-xl border-[1px] p-4">
                    <div className="flex items-center gap-4">
                      <img
                        ...
                        className="h-32 w-1/3 rounded-xl object-cover"
                      />
            ...
            <div
              className={
                ...
                UserReview[0]?.review_by_user?.user?.length !== 0
                  ? "grid grid-rows-1 gap-4 md:grid-cols-2 xl:grid-cols-1"
                  : ""
              }
            >
              {UserReview &&
